...
[`数据库/5.20完善数据集_research_db_v0.7_expansion_planning.xlsx`](数据库/5.20完善数据集_research_db_v0.7_expansion_planning.xlsx)
...
In v0.7, expansion-planning sheets were added for source screening, sampling targets, intake templates, seed candidates, and expansion QA. This version does not import new molecules into the curated database; it prepares the next evidence-controlled expansion step.
...
python3 scripts/create_expansion_workbook_v0_7.py
```
